...
-- tb_mensagem
insert into tb_mensagem (id_categoria, mensagem, referencia) values (1, 'Queria que você fosse meu mouse, pra eu poder passar a mão em você toda hora.
', 'https://eufacoprogramas.com/10-cantadas-de-ti-melhores/'),
																	(1, 'Você é o Modem que me conecta.', 'https://eufacoprogramas.com/10-cantadas-de-ti-melhores/'),
																	(1, 'Posso por meu pen-drive na sua porta USB? Pode ser na frontal ou na traseira, tanto faz.
', 'https://eufacoprogramas.com/10-cantadas-de-ti-melhores/'),
																	(1, 'Posso por meu pen-drive na sua porta USB? Pode ser na frontal ou na traseira, tanto faz.
', 'https://eufacoprogramas.com/10-cantadas-de-ti-melhores/'),
																	(1, 'Nem a mais potente placa de vídeo iria reproduzir os gráficos da sua beleza.
', 'https://eufacoprogramas.com/10-cantadas-de-ti-melhores/'),
																	(1, 'Você hackeou o Google? Porque qualquer coisa que eu procuro, sempre te encontro.
', 'https://eufacoprogramas.com/10-cantadas-de-ti-melhores/'),
																	(1, 'Você deve ser Windows 95, porque você me deixa instável.
', 'https://eufacoprogramas.com/10-cantadas-de-ti-melhores/'),
																	(1, 'Pode não acreditar, mas quando a vi pela janela, foi amor à primeira “VISTA”.
', 'https://eufacoprogramas.com/10-cantadas-de-ti-melhores/'),
																	(1, 'Posso te chamar de CSS? Porque eu gosto do seu estilo.
', 'https://eufacoprogramas.com/10-cantadas-de-ti-melhores/'),
																	(1, 'Para tirar você da cabeça, só formatando!
', 'https://eufacoprogramas.com/10-cantadas-de-ti-melhores/'),
																	(1, '[me != me]. [me += you].
', 'https://eufacoprogramas.com/10-cantadas-de-ti-melhores/'),
																	(1, 'Gata, você é WIFI? Porque estou sentindo a conexão…
', 'https://eufacoprogramas.com/10-cantadas-de-ti-melhores/'),
																	(1, 'Gata, você é mais quente que o meu notebook.
', 'https://eufacoprogramas.com/10-cantadas-de-ti-melhores/'),
																	(1, 'Você me ganhou no ‘Hello World’ 
', 'https://eufacoprogramas.com/10-cantadas-de-ti-melhores/'),
																	(1, 'Gato… Alt V nunca + me Ctrl lei! 
', 'https://techdicas.net.br/as-melhores-cantadas-de-ti-parte-ii/),
																	(1, 'Gato, perto de você, eu sou como o Internet Explorer. Só de olhar pra mim que eu já travo. 
', 'https://techdicas.net.br/as-melhores-cantadas-de-ti-parte-ii/),
																	(1, 'Penso mais em você que as páginas indexadas pelo google.
', 'https://techdicas.net.br/as-melhores-cantadas-de-ti-parte-ii/),
																	(1, 'Você é o .gif que anima minha vida. 
', 'https://techdicas.net.br/as-melhores-cantadas-de-ti-parte-ii/),
																	(1, 'Entre tantas variáveis, você é uma constante no meu coração.
', 'https://techdicas.net.br/as-melhores-cantadas-de-ti-parte-ii/),
																	(1, 'Você é a chave estrangeira da minha entidade coração. 
', 'https://techdicas.net.br/as-melhores-cantadas-de-ti-parte-ii/),
																	(1, 'Gata, você não é Windows, mas que vista, hein?
', 'https://www.cantadascasa.com/informatica-cantadas.html),
																	(1, 'Gata, você ainda é nova na minha vida, mas já posso te dar acesso root ao meu coração.
', 'https://www.cantadascasa.com/informatica-cantadas.html),
																	(1, 'Fui falar "Oi", mas meu corretor ortográfico corrigiu para "Te Amo".
', 'https://www.cantadascasa.com/informatica-cantadas.html),
																	(1, 'Gata, vem em mim que hoje estou chmod 777.
', 'https://www.cantadascasa.com/informatica-cantadas.html),
																	(1, 'Gata, você não é a fonte do meu PC, mas sem você eu vivo desligado.
', 'https://www.cantadascasa.com/informatica-cantadas.html),
																	(1, 'Você é professora de informática? Então abre a sua windows pra mim que eu te achei excelente
', 'https://www.cantadascasa.com/informatica-cantadas.html),
																	(1, 'Já que hoje é dia da informática, que tal a gente fazer um programinha?!
', 'https://www.cantadascasa.com/informatica-cantadas.html),
																	(1, 'Gata, vamos brincar de código binário? Você me dá o 0 e eu te ponho o 1.
', 'https://www.cantadascasa.com/informatica-cantadas.html);

insert into tb_mensagem (id_categoria, mensagem, referencia) values (2, 'O IFRN tem 123 anos de idade.', 'IF ORACLE'),
																	(2, 'O curso que mais aparece nos campi integrado ao ensino médio é informática.
', 'IF ORACLE'),
                                                                    ...
                                                                    (2, 'Todo ano há exame de seleção do IFRN, com um edital, e apoio PROITEC aos estudantes de escolas públicas.
', 'IF ORACLE'),
																	(2, 'O reitor do IFRN atualmente é Arnóbio. A cada 4 anos, os estudantes, professores e técnicos administrativos votam para eleger reitor e diretores.
', 'IF ORACLE'),
																	...
																	(2, 'Cada campus possui setor médico e dentário disponíveis para os estudantes.
', 'IF ORACLE'),
																	(2, 'O WiFI chamado Eduroam serve para todos os campi de qualquer instituto federal de todo o país.
', 'IF ORACLE');

insert into tb_mensagem (id_categoria, mensagem, referencia) values (3, 'Cerca de 72 horas de conteúdo são enviadas ao site de vídeos Youtube a cada minuto.', 'https://segredosdomundo.r7.com/curiosidades-aleatorias/'),
																	...
																	(3, 'Certamente, a maior palavra da língua portuguesa refere-se a uma doença causada pela respiração de cinzas vulcânicas: pneumoultramicroscopicossilicovulcanoconiótico.

', 'https://segredosdomundo.r7.com/curiosidades-aleatorias/'),
																	...
																	(3, 'A avenida mais larga do mundo fica na Argentina.
...
insert into tb_mensagem (id_categoria, mensagem, referencia) values (4, 'Sou professora da segunda série do ensino fundamental numa escola de minha cidade. No dia da primeira avaliação de ciências naturais, perguntei aos alunos:
– Qual a estrela mais próxima da Terra?
Uma aluna, achando-se preparada, respondeu de imediato:
– A estrela cadente.', 'https://www.selecoes.com.br/humor/melhores-piadas-de-escola/'),
																	(4, 'O pai pergunta à filha:
— Filha, você acha que sua professora desconfia que estou fazendo suas lições de casa?
— Acho que sim, pai. Ela até disse que você deveria voltar pra escola! ', 'https://www.selecoes.com.br/humor/melhores-piadas-de-escola/'),
																	(4, 'Voltando da escola, a mãe de Joãozinho pergunta como foi a prova e ele responde:

— Como no Polo Norte.

— Como assim?

— Tudo abaixo de zero!', 'https://www.selecoes.com.br/humor/melhores-piadas-de-escola/'),
																	(4, 'Professor: Qual é a velocidade da luz?
Aluno: Não sei ao certo, mas de manhã sempre chega rápido demais.', 'https://www.selecoes.com.br/humor/melhores-piadas-de-escola/'),
																	(4, 'Professor: Qual é a velocidade da luz?
Aluno: Não sei ao certo, mas de manhã sempre chega rápido demais.', 'https://www.selecoes.com.br/humor/melhores-piadas-de-escola/'),
																	(4, 'Um aluno pergunta ao professor:

— Professor, arroz é com S ou com Z?

E o professor responde:

— Aqui eu não sei, mas lá em casa é com feijão!.', 'https://www.selecoes.com.br/humor/melhores-piadas-de-escola/'),
																	(4, '— Quero ver seu boletim!

— Infelizmente não vai dar!

— Como não vai dar ?

— Eu emprestei pra um amigo… ele queria dar um susto no pai dele!', 'https://www.selecoes.com.br/humor/melhores-piadas-de-escola/'),
																	(4, 'Joãozinho pede ajuda a seu avô para encontrar o m.m.c e ele responde

— Mas ainda não encontraram?! Desde a minha época procuram esse sujeito!', 'https://www.selecoes.com.br/humor/melhores-piadas-de-escola/'),
																	(4, '— Quero ver seu boletim!
...
— Eu emprestei pra um amigo… ele queria dar um susto no pai dele!', 'https://www.selecoes.com.br/humor/melhores-piadas-de-escola/'),
																	(4, 'Joãozinho chega atrasado à escola. Quando ele entra na sala de aula, a professora diz:
...
- Ué, professora! Não é a senhora que diz que nunca é tarde para aprender?', 'https://www.maioresemelhores.com/piadas-de-joaozinho/'),
																	(4, '- Mãe, meus amigos estão dizendo que eu sou interesseiro.
- Quais amigos, Joãozinho?
- Se você me der 10 reais eu te conto.', 'https://www.maioresemelhores.com/piadas-de-joaozinho/'),
																	(4, 'A professora pergunta para o Joãozinho:
- Joãozinho, por que você não fez a lição de casa?
- Porque eu moro em apartamento.', 'https://www.maioresemelhores.com/piadas-de-joaozinho/'),
																	(4, 'Joãozinho chegou em casa pulando de alegria.
...
- Quem não fez a lição de casa.', 'https://www.maioresemelhores.com/piadas-de-joaozinho/'),
																	(4, 'Joãozinho pergunta para sua mãe:
- Mãe, a senhora sabia que vermelho é a cor do amor?
- Claro que sim, filho.
- Te amo, mãe. Toma aqui meu boletim.', 'https://www.maioresemelhores.com/piadas-de-joaozinho/'),
																	(4, 'J- Joãozinho, conjugue o verbo andar.
- Eu ando, tu andas, ele anda, nós...
- Mais rápido, Joãozinho!
- Eu corro, tu corres, ele corre, nós...', 'https://www.maioresemelhores.com/piadas-de-joaozinho/'),